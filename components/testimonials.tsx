...
export function Testimonial({
    ...
    return (
        <article
            className={`relative rounded-2xl bg-gradient-to-br from-gray-900/60 via-gray-800/40 to-gray-900/60 p-6 shadow-lg backdrop-blur-md transition-opacity hover:scale-105 hover:shadow-2xl before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-gray-700/50 before:[background:linear-gradient(to_right,rgba(40,40,40,0.9),rgba(50,50,50,0.8),rgba(40,40,40,0.9))_border-box] before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)] ${
